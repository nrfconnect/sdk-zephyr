...
/* gpio7 - P7.4 CTRLSEL = 3 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938e00UL, 4, 3);
/* gpio7 - P7.7 CTRLSEL = 3 */
UICR_GPIO_PIN_CNF_CTRLSEL_SET(0x5f938e00UL, 7, 3);
/* cpuflpr_vevif_tx IRQ => FLPR */
UICR_IRQMAP_IRQ_SINK_SET(NRFX_IRQ_NUMBER_GET(0x5f8d4000UL), NRF_PROCESSOR_FLPR);
/* uart120 IRQ => FLPR */
UICR_IRQMAP_IRQ_SINK_SET(NRFX_IRQ_NUMBER_GET(0x5f8e6000UL), NRF_PROCESSOR_FLPR);