...
static const struct device_subsys_data subsys_data[] = {
	 ...
	 */
	{
		...
		.startup_us = (DT_STRING_TOKEN(DT_NODELABEL(lfclk), k32src) ==
		CLOCK_CONTROL_NRF_K32SRC_RC) ? 1000 : 500000
	}
...
#if NRF_CLOCK_HAS_HFCLKAUDIO
	{
		.dev = DEVICE_DT_GET_ONE(nordic_nrf_clock_hfclkaudio),
		.subsys_data =  subsys_data_hfclkaudio,
		.subsys_cnt = ARRAY_SIZE(subsys_data_hfclkaudio)
	},
#endif /* NRF_CLOCK_HAS_HFCLKAUDIO */
#if NRF_CLOCK_HAS_XO24M
	{
