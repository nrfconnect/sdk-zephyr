...
function(zephyr_sources)
  foreach(arg ${ARGV})
    ...
    target_sources(${IMAGE}zephyr PRIVATE ${arg})
  endforeach()
endfunction()
...
function(zephyr_linker_sources location)
  ...
  get_property(cleared GLOBAL PROPERTY ${IMAGE}snippet_files_cleared)
  if (NOT DEFINED cleared)
    ...
    set_property(GLOBAL PROPERTY ${IMAGE}snippet_files_cleared true)
  endif()
