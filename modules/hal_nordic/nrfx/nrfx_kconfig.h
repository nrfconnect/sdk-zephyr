...
#define NRFX_CLOCK_CONFIG_USE_LFRC_CALIBRATION 1
	...
	(DT_ENUM_HAS_VALUE(DT_NODELABEL(lfclk), k32src, rc) && !defined(CONFIG_CLOCK_CONTROL_NRF))
...
#define NRFX_CLOCK_CONFIG_LF_SRC 0
	...
	(DT_ENUM_HAS_VALUE(DT_NODELABEL(lfclk), k32src, xtal) && !defined(CONFIG_CLOCK_CONTROL_NRF))
#if defined(CONFIG_SOC_SERIES_NRF91) || defined(CONFIG_SOC_COMPATIBLE_NRF53X)
