...
to run on the nRF52840 SoC on the PCA10090 Development Kit hardware.
...
buttons, switches and Arduino pin headers on the PCA10090 board. It is, however,
possible to route some of the pins of the nRF52840 SoC to the nRF9160 SiP.

More information about the board can be found at the
`Nordic Low power cellular IoT`_. The `Nordic Semiconductor document library`_
contains the processor's information and the datasheet.

Hardware
********

PCA10090 DK has two external oscillators. The frequency of
...
.. _Nordic Semiconductor document library: https://www.nordicsemi.com/DocLib
