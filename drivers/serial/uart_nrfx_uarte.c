...
#error "No PPI or DPPI"
	...
	(defined(CONFIG_HAS_HW_NRF_UARTE00) && !defined(CONFIG_UART_00_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE20) && !defined(CONFIG_UART_20_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE21) && !defined(CONFIG_UART_21_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE22) && !defined(CONFIG_UART_22_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE130) && !defined(CONFIG_UART_130_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE131) && !defined(CONFIG_UART_131_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE132) && !defined(CONFIG_UART_132_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE133) && !defined(CONFIG_UART_133_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE134) && !defined(CONFIG_UART_134_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE135) && !defined(CONFIG_UART_135_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE136) && !defined(CONFIG_UART_136_ASYNC)) || \
	(defined(CONFIG_HAS_HW_NRF_UARTE137) && !defined(CONFIG_UART_137_ASYNC))
...
#define UARTE_ANY_ASYNC 1
	...
	defined(CONFIG_UART_00_NRF_HW_ASYNC) || defined(CONFIG_UART_20_NRF_HW_ASYNC) || \
	defined(CONFIG_UART_21_NRF_HW_ASYNC) || defined(CONFIG_UART_22_NRF_HW_ASYNC) || \
	defined(CONFIG_UART_130_NRF_HW_ASYNC) || defined(CONFIG_UART_131_NRF_HW_ASYNC) || \
	defined(CONFIG_UART_132_NRF_HW_ASYNC) || defined(CONFIG_UART_133_NRF_HW_ASYNC) || \
	defined(CONFIG_UART_134_NRF_HW_ASYNC) || defined(CONFIG_UART_135_NRF_HW_ASYNC) || \
	defined(CONFIG_UART_136_NRF_HW_ASYNC) || defined(CONFIG_UART_137_NRF_HW_ASYNC)
#define UARTE_HW_ASYNC 1
	...
	defined(CONFIG_UART_00_ENHANCED_POLL_OUT) || defined(CONFIG_UART_20_ENHANCED_POLL_OUT) || \
	defined(CONFIG_UART_21_ENHANCED_POLL_OUT) || defined(CONFIG_UART_22_ENHANCED_POLL_OUT) || \
	defined(CONFIG_UART_130_ENHANCED_POLL_OUT) || defined(CONFIG_UART_131_ENHANCED_POLL_OUT) || \
	defined(CONFIG_UART_132_ENHANCED_POLL_OUT) || defined(CONFIG_UART_133_ENHANCED_POLL_OUT) || \
	defined(CONFIG_UART_134_ENHANCED_POLL_OUT) || defined(CONFIG_UART_135_ENHANCED_POLL_OUT) || \
	defined(CONFIG_UART_136_ENHANCED_POLL_OUT) || defined(CONFIG_UART_137_ENHANCED_POLL_OUT)
...
#ifdef CONFIG_HAS_HW_NRF_UART00
UART_NRF_UARTE_DEVICE(00);
#endif

#ifdef CONFIG_HAS_HW_NRF_UART20
UART_NRF_UARTE_DEVICE(20);
#endif

#ifdef CONFIG_HAS_HW_NRF_UART21
UART_NRF_UARTE_DEVICE(21);
#endif

#ifdef CONFIG_HAS_HW_NRF_UART22
UART_NRF_UARTE_DEVICE(22);
#endif

#ifdef CONFIG_HAS_HW_NRF_UART13
UART_NRF_UARTE_DEVICE(13);
#endif
