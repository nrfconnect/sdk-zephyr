...
if(SB_CONFIG_NORDIC_LOG_STM OR SB_CONFIG_NORDIC_LOG_STM_DICT OR SB_CONFIG_NORDIC_LOG_STM_TPIU_DICT)
  get_property(all_images GLOBAL PROPERTY sysbuild_images)
  foreach(image ${all_images})
    if(NOT img STREQUAL "uicr")
      if(SB_CONFIG_NORDIC_LOG_STM)
        set(stm_snippet "nordic-log-stm")
      elseif(SB_CONFIG_NORDIC_LOG_STM_DICT)
        set(stm_snippet "nordic-log-stm-dict")
      elseif(NORDIC_LOG_STM_MODE_TPIU_DICT)
        set(stm_snippet "nordic-log-stm-tpiu-dict")
      endif()
      sysbuild_cache_set(VAR ${image}_SNIPPET APPEND REMOVE_DUPLICATES ${stm_snippet})
    endif()
  endforeach()
endif()
