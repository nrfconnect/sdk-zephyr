...
def get_additional_node_kwargs(node: edtlib.Node) -> dict[str, Any]:
    additional_kwargs = {}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--soc",
        required=True,
        choices=list(soc.value for soc in Soc),
        help=(
...
def main() -> None:
    ...
    lookup_tables = build_lookup_tables(dt, Soc(args.soc), processor)
...
def build_lookup_tables(dt: edtlib.EDT, soc: Soc, processor: ProcessorId) -> SocLookupTables:
    if soc == Soc.NRF54H20:
        ctrlsel_lookup = {
            # CAN120
            0x5F8D_8000: {
