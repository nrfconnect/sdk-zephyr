...
struct zms_iter {
	...
	bool exhausted;
	/**  Sector of the last ATE seen, cached to avoid re-reading the cycle below every step */
	int previous_sector_num;
	/**  Cycle count of the sector identified by previous_sector_num */
