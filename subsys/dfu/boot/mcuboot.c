...
#define FLASH_AREA_IMAGE_SCRATCH DT_FLASH_AREA_SCRATCH_NONSECURE_ID
#else
#define FLASH_BANK0_ID DT_FLASH_AREA_IMAGE_0_ID
#define FLASH_BANK1_ID DT_FLASH_AREA_IMAGE_1_ID
#define FLASH_AREA_IMAGE_SCRATCH DT_FLASH_AREA_SCRATCH_ID
...
int mcuboot_swap_type(void)
{
	...
	rc = boot_read_swap_state(FLASH_AREA_IMAGE_PRIMARY, &state_slot0);
	if (rc != 0) {
		return rc;
	}

	rc = boot_read_swap_state(FLASH_AREA_IMAGE_SECONDARY, &state_slot1);
	if (rc != 0) {
		return rc;
	}
