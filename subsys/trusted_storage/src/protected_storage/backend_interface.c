...
psa_status_t psa_ps_get_info(psa_storage_uid_t uid, struct psa_storage_info_t *p_info)
{
	...
	return trusted_get_info(uid, CONFIG_PROTECTED_STORAGE_PREFIX, p_info);
}
			...
			size_t *p_data_length)
{
	...
	return trusted_get(uid, CONFIG_PROTECTED_STORAGE_PREFIX, data_offset, data_length, p_data,
			   p_data_length);
}
			...
			psa_storage_create_flags_t create_flags)
{
	...
	return trusted_set(uid, CONFIG_PROTECTED_STORAGE_PREFIX, data_length, p_data, create_flags);
}

psa_status_t psa_ps_remove(psa_storage_uid_t uid)
{
	return trusted_remove(uid, CONFIG_PROTECTED_STORAGE_PREFIX);
}
